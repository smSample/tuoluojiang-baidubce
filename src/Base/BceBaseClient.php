...
use Tuoluojiang\Baidubce\Base\Services\Bos\BosOptions;
...
class BceBaseClient
{
    ...
    protected static function convertHttpHeadersToMetadata(array $headers)
    {
        ...
        if (isset($headers[HttpHeaders::BCE_VERSION_ID])) {
            $metadata[BosOptions::BCE_VERSION_ID] =
                $headers[HttpHeaders::BCE_VERSION_ID];
        }
        return $metadata;
    }
