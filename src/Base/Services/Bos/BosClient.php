...
namespace Tuoluojiang\Baidubce\Base\Services\Bos;
...
use Tuoluojiang\Baidubce\Base\Util\MimeTypes;
use Tuoluojiang\Baidubce\Base\Util\HashUtils;
use Tuoluojiang\Baidubce\Base\Util\HttpUtils;
use Tuoluojiang\Baidubce\Base\Util\StringUtils;
...
class BosClient extends BceBaseClient
{
     ...
     *
     */
    function genEndpoint($bucketName = "", $isBucketReq, &$config) {
        ...
        if ($isBucketReq) {
            ...
            if ($config[BceClientConfigOptions::CUSTOM] === false) {
