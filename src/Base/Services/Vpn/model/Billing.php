...
namespace Tuoluojiang\Baidubce\Base\Services\Vpn\model;
...
class Billing
{
     ...
     *            Billing method ，ByTraffic or ByBandwidth
     *
     ...
     */
    function __construct($paymentTiming='Postpaid', $billingMethod='ByBandwidth', $reservationLength=1, $reservationTimeUnit='Month')
    {
