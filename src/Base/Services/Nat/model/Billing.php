...
namespace Tuoluojiang\Baidubce\Base\Services\Nat\model;
...
class Billing
{
     ...
     */
    function __construct($paymentTiming = 'Postpaid', $reservationLength = null, $reservationTimeUnit = null)
    {
        if ($paymentTiming !== null) {
            $this->paymentTiming = $paymentTiming;
        }
        if ($reservationLength != null || $reservationTimeUnit != null) {
